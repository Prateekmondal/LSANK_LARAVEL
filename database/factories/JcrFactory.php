...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Jcr>
 */
class JcrFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            'fieldName' => fake(),
            'wellNo' => fake(),
            'jobDate' => now()->toDate()->jobDate(),
            'jobNo' => rand(0, 999999),
            'workOrderDate' => now()->toDate()->jobDate(),
            'indentNo' => fake(),
            'rigNo' => 'Test-123',
            'kb' => 10.2,
            'gl' => 8.25,
