...
@section('content')
    ...
    <div class='container-fluid px-0' id='grad1'>
        <div class='container px-0 pt-3 pb-0 mt-3 mb-3 text-center bg-white'>
            ...
            <form id='msform' action='{{ route('jcr.update') }}' method='POST'>
                @csrf
                                ...
                                <fieldset id='basicinfo'>
                                    <div class='form-card step w-20'>
                                        ...
                                        <div id='div_id_fieldName' class='mb-3'>
                                            <input type="number" hidden name="id" value="{{ old('id', $jcrs->id) }}">
                                            ...
                                            <input type='text' name='fieldName' placeholder='Field/Area'
                                                ...
                                                value='{{ old('fieldName', $jcrs->fieldName) }}'>
                                                @error('fieldName')
                                        ...
                                        <div id='div_id_loggingType' class='mb-3'>
                                            ...
                                            <select name='loggingType' type='text' placeholder='Logging Type'
                                                class='select form-select' id='id_loggingType'>
                                                <option value='' disabled {{ old('loggingType') == '' ? 'selected' : ''}}>--- Select Logging Type ---</option>
                                                @foreach ($loggingTypes as $loggingType) 
                                                    <option value={{ $loggingType }} {{ old('loggingType') == $loggingType ? 'selected' : ($jcrs->loggingType == $loggingType ? 'selected' : '')}}>{{ $loggingType }}</option>
                                                @endforeach
                                            </select>
                                            @error('loggingType')
                                            <small class='error'>{{ $message }}</small>
                                        ...
                                        <div id='div_id_logType' class='mb-3'>
                                            ...
                                            <select name='logType' type='text' placeholder='Job Type' class='select form-select'
                                                id='id_logType'>
                                                <option value='' disabled {{ old('logType') == '' ? 'selected' : '' }}>--- Select Job Type ---</option>
                                                @foreach ($logTypes as $logType)
                                                    <option value='{{ $logType }}' {{ old('logType') == $logType || $jcrs->logType == $logType ? 'selected' : '' }}>
                                                        {{ $logType }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div id='div_id_unitNo' class='mb-3'>
                                            ...
                                            <select name='unitNo' class='select form-select' id='id_unitNo'>
                                                ...
                                                @foreach ($unitNos as $unitNo)
                                                    <option value='{{ $unitNo }}' {{ old('unitNo') == $unitNo || $jcrs->unitNo == $unitNo ? 'selected' : '' }}>
                                                        {{ $unitNo }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div id='div_id_jobDate' class='mb-3'>
                                            ...
                                            <input type='text' name='jobDate' placeholder='YYYY-MM-DD' data-mask='0000-00-00'
                                                ...
                                                value='{{ old('jobDate', date('Y-m-d', strtotime($jcrs->jobDate))) }}'>
                                            @error('jobDate')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div id='div_id_workOrderDate' class='mb-3'>
                                            ...
                                            <input type='text' name='workOrderDate' placeholder='YYYY-MM-DD'
                                                data-mask='0000-00-00' class='dateinput form-control' id='id_workOrderDate'
                                                autocomplete='off' maxlength='10'
                                                value='{{old('workOrderDate', date('Y-m-d', strtotime($jcrs->workOrderDate))) }}'>
                                            @error('workOrderDate')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_indentNo' class='mb-3'>
                                            ...
                                            <input type='text' name='indentNo' placeholder='LGOOO123456'
                                                ...
                                                value='{{ old('indentNo', $jcrs->indentNo) }}'>
                                            @error('indentNo')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div id='div_id_kb' class='mb-3'>
                                            ...
                                            <input type='text' name='kb' placeholder='KB'
                                                class='textinput textInput form-control' id='id_kb' value='{{ old('kb', $jcrs->kb) }}'>
                                            @error('kb')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_gl' class='mb-3'>
                                            ...
                                            <input type='text' name='gl' placeholder='GL'
                                                class='textinput textInput form-control' id='id_gl' value='{{ old('gl', $jcrs->gl) }}'>
                                            @error('gl')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_wellOwner' class='mb-3'>
                                            ...
                                            <select name='wellOwner' type='text' placeholder='Well Owner'
                                                class='select form-select' id='id_wellOwner'>
                                                <option value='' disabled {{ old('wellOwner') == '' ? 'selected' : '' }}>---
                                                    Select Well Owner ---</option>
                                                @foreach ($wellOwners as $wellOwner)
                                                    <option value='{{ $wellOwner }}' {{ old('wellOwner') == $wellOwner || $jcrs->wellOwner == $wellOwner ? 'selected' : '' }}>{{ $wellOwner }}</option>
                                                @endforeach
                                            </select>
                                            @error('wellOwner')
                                            <small class='error'>{{ $message }}</small>
                                        ...
                                        <div id='div_id_mastVanNo' class='mb-3'>
                                            ...
                                            <input type='text' name='mastVanNo' placeholder='Mast/Van Number' class='textinput textInput form-control' id='id_mastVanNo' value='{{ old('mastVanNo') ? old('mastVanNo') : $jcrs->mastVanNo}}'>
                                            @error('mastVanNo')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_lvNo' class='mb-3'>
                                            ...
                                            <input type='text' name='lvNo' placeholder='Light Vehicle Number'
                                                class='textinput textInput form-control' id='id_lvNo' value='{{ old('lvNo') ? old('lvNo') : $jcrs->lvNo }}'>
                                            @error('lvNo')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_wellType' class='mb-3'>
                                            ...
                                            <select name='wellType' type='text' placeholder='Well Type'
                                                class='select form-select' id='id_wellType'>
                                                <option value='' disabled {{ old('wellType') == '' ? 'selected' : ''}}>--- Select Well Type ---</option>
                                                @foreach ($wellTypes as $wellType)
                                                    <option value='{{$wellType}}' {{ old('wellType') == $wellType || $jcrs->wellType == $wellType ? 'selected' : ''}}>
                                                        {{$wellType}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div id='div_id_rigType' class='mb-3'>
                                            ...
                                            <select name='rigType' type='text' placeholder='Rig Type' class='select form-select'
                                                id='id_rigType'>
                                                <option value='' disabled {{ old('rigType') == '' ? 'selected' : '' }}>--- Select Rig Type ---</option>
                                                @foreach($rigTypes as $rigType)
                                                    <option value='{{ $rigType }}' {{ old('rigType') == $rigType || $jcrs->rigType == $rigType ? 'selected' : '' }}>
                                                        {{ $rigType }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <fieldset id='timeinfo'>
                                    <div class='form-card step'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='assembled_date' placeholder='YYYY-MM-DD'
                                                        ...
                                                        id='id_assembled_date' autocomplete='on' maxlength='16'
                                                        value='{{ old('assembled_date') ? old('assembled_date') : date('Y-m-d', strtotime($jcrs->assembled_date)) }}'>
                                                    @error('assembled_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='assembled_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_assembled_time' autocomplete='on' maxlength='16'
                                                        value='{{ old('assembled_time') ? old('assembled_time') : date('H:i', strtotime($jcrs->assembled_time)) }}'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='depOffice_date' placeholder='YYYY-MM-DD'
                                                        data-mask='0000-00-00' class='datetimeinput form-control'
                                                        id='id_depOffice_date' autocomplete='off' maxlength='16'
                                                        value='{{ old('depOffice_date') ? old('depOffice_date') : date('Y-m-d', strtotime($jcrs->depOffice_date)) }}'>
                                                    @error('depOffice_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='depOffice_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_depOffice_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('depOffice_time') ? old('depOffice_time') : date('H:i', strtotime($jcrs->assembled_time)) }}'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='arrivalSite_date' placeholder='YYYY-MM-DD'
                                                        ...
                                                        value='{{ old('arrivalSite_date') ? old('arrivalSite_date') : date('Y-m-d', strtotime($jcrs->arrivalSite_date)) }}'>
                                                    @error('arrivalSite_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='arrivalSite_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_arrivalSite_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('arrivalSite_time') ? old('arrivalSite_time') : date('H:i', strtotime($jcrs->arrivalSite_time)) }}'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='indented_date' placeholder='YYYY-MM-DD'
                                                        data-mask='0000-00-00' class='datetimeinput form-control'
                                                        id='id_indented_date' autocomplete='off' maxlength='16'
                                                        value='{{ old('indented_date', date('Y-m-d', strtotime($jcrs->indented_date))) }}'>
                                                    @error('indented_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='indented_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_indented_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('indented_time', date('H:i', strtotime($jcrs->indented_time))) }}'>
                                                    @error('indented_time')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellReadiness_date' placeholder='YYYY-MM-DD'
                                                        ...
                                                        value='{{ old('wellReadiness_date') ? old('wellReadiness_date') : date('Y-m-d', strtotime($jcrs->wellReadiness_date)) }}'>
                                                    @error('wellReadiness_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellReadiness_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_wellReadiness_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('wellReadiness_time') ? old('wellReadiness_time') : date('H:i', strtotime($jcrs->wellReadiness_time)) }}'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellTaken_date' placeholder='YYYY-MM-DD'
                                                        data-mask='0000-00-00' class='datetimeinput form-control'
                                                        id='id_wellTaken_date' autocomplete='off' maxlength='16'
                                                        value='{{ old('wellTaken_date') ? old('wellTaken_date') : date('Y-m-d', strtotime($jcrs->wellTaken_date)) }}'>
                                                    @error('wellTaken_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellTaken_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_wellTaken_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('wellTaken_time') ? old('wellTaken_time') : date('H:i', strtotime($jcrs->wellTaken_time)) }}'>
                                        ...
                                        <div id='div_id_rigUP' class='mb-3'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='rigUP_date' placeholder='YYYY-MM-DD'
                                                        data-mask='0000-00-00' class='datetimeinput form-control'
                                                        id='id_rigUP_date' autocomplete='off' maxlength='16'
                                                        value='{{ old('rigUP_date') ? old('rigUP_date') : date('Y-m-d', strtotime($jcrs->rigUP_date)) }}'>
                                                    @error('rigUP_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='rigUP_time' placeholder='HH:MM' data-mask='00:00'
                                                        ...
                                                        maxlength='16'
                                                        value='{{ old('rigUP_time') ? old('rigUP_time') : date('H:i', strtotime($jcrs->rigUP_time)) }}'>
                                                    @error('rigUP_time')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellHandOver_date' placeholder='YYYY-MM-DD'
                                                        ...
                                                        value='{{ old('wellHandOver_date') ? old('wellHandOver_date') : date('Y-m-d', strtotime($jcrs->wellHandOver_date)) }}'>
                                                    @error('wellHandOver_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='wellHandOver_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_wellHandOver_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('wellHandOver_time') ? old('wellHandOver_time') : date('H:i', strtotime($jcrs->wellHandOver_time)) }}'>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='depSite_date' placeholder='YYYY-MM-DD'
                                                        data-mask='0000-00-00' class='datetimeinput form-control'
                                                        id='id_depSite_date' autocomplete='off' maxlength='16'
                                                        value='{{ old('depSite_date') ? old('depSite_date') : date('Y-m-d', strtotime($jcrs->depSite_date)) }}'>
                                                    @error('depSite_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='depSite_time' placeholder='HH:MM' data-mask='00:00'
                                                        class='datetimeinput form-control' id='id_depSite_time'
                                                        autocomplete='off' maxlength='16'
                                                        value='{{ old('depSite_time') ? old('depSite_time') : date('H:i', strtotime($jcrs->depSite_time)) }}'>
                                                    @error('depSite_time')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class='d-flex'>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='arrivalOffice_date' placeholder='YYYY-MM-DD'
                                                        ...
                                                        value='{{ old('arrivalOffice_date') ? old('arrivalOffice_date') : date('Y-m-d', strtotime($jcrs->arrivalOffice_date)) }}'>
                                                    @error('arrivalOffice_date')
                                                    <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class='container-fluid mx-1 p-0'>
                                                    <input type='text' name='arrivalOffice_time' placeholder='HH:MM'
                                                        data-mask='00:00' class='datetimeinput form-control'
                                                        id='id_arrivalOffice_time' autocomplete='off' maxlength='16'
                                                        value='{{ old('arrivalOffice_time') ? old('arrivalOffice_time') : date('H:i', strtotime($jcrs->arrivalOffice_time)) }}'>
                                        ...
                                        <div id='div_id_preparationTime' class='mb-3'>
                                            ...
                                            <input type='text' name='preparationTime'
                                                placeholder='Enter Preparation time in hours.'
                                                class='textinput textInput form-control' id='id_preparationTime'
                                                value='{{ old('preparationTime') ? old('preparationTime') : $jcrs->preparationTime }}'>
                                        ...
                                        <div id='div_id_postProceTime' class='mb-3'>
                                            ...
                                            <input type='text' name='postProceTime'
                                                placeholder='Enter Post Processing time in hours'
                                                class='textinput textInput form-control' id='id_postProceTime'
                                                value='{{ old('postProceTime') ? old('postProceTime') : $jcrs->postProceTime }}'>
                                            @error('postProceTime')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class='form-card step'>
                                        ...
                                        <div id='div_id_depthDriller' class='mb-3'>
                                            ...
                                            <input type='text' name='depthDriller' placeholder='Depth Driller'
                                                ...
                                                value='{{ old('depthDriller') ? old('depthDriller') : $jcrs->depthDriller }}'>
                                        </div>
                                        <div id='div_id_depthLogger' class='mb-3'>
                                            ...
                                            <input type='text' name='depthLogger' placeholder='Depth Logger'
                                                ...
                                                value='{{ old('depthLogger') ? old('depthLogger') : $jcrs->depthLogger  }}'>
                                        </div>
                                        <div id='div_id_casingSize' class='mb-3'>
                                            ...
                                            <input type='text' name='casingSize' placeholder='Casing Size(inch)'
                                                ...
                                                value='{{ old('casingSize') ? old('depthDriller') : $jcrs->depthDriller }}'>
                                        </div>
                                        <div id='div_id_casingShoeDriller' class='mb-3'>
                                            ...
                                            <input type='text' name='casingShoeDriller' placeholder='Casing Shoe Driller'
                                                ...
                                                value='{{ old('casingShoeDriller') ? old('casingShoeDriller') : $jcrs->casingShoeDriller }}'>
                                        </div>
                                        <div id='div_id_casingShoeLogger' class='mb-3'>
                                            ...
                                            <input type='text' name='casingShoeLogger' placeholder='Casing Shoe Logger'
                                                ...
                                                value='{{ old('casingShoeLogger') ? old('casingShoeLogger') : $jcrs->casingShoeLogger }}'>
                                        </div>
                                        <div id='div_id_floatCollar' class='mb-3'>
                                            ...
                                            <input type='text' name='floatCollar' placeholder='Float Collar'
                                                ...
                                                value='{{ old('floatCollar') ? old('floatCollar') : $jcrs->floatCollar }}'>
                                        </div>
                                        <div id='div_id_bitSize' class='mb-3'>
                                            ...
                                            <input type='text' name='bitSize' placeholder='Bit Size(inch)'
                                                ...
                                                value='{{ old('bitSize') ? old('bitSize') : $jcrs->bitSize }}'>
                                        </div>
                                        <div id='div_id_tubingSize' class='mb-3'>
                                            ...
                                            <input type='text' name='tubingSize' placeholder='Tubing Size(inch)'
                                                ...
                                                value='{{ old('tubingSize') ? old('tubingSize') : $jcrs->tubingSize }}'>
                                        </div>
                                        <div id='div_id_t_shoe_Packer' class='mb-3'>
                                            ...
                                            <input type='text' name='t_shoe_Packer' placeholder='T/shoe/Packer'
                                                ...
                                                value='{{ old('t_shoe_Packer') ? old('t_shoe_Packer') : $jcrs->t_shoe_Packer }}'>
                                        </div>
                                        <div id='div_id_s_nippletopexp' class='mb-3'>
                                            ...
                                            <input type='text' name='s_nippletopexp' placeholder='S/nipple top exp.'
                                                ...
                                                value='{{ old('s_nippletopexp') ? old('s_nippsetopexp') : $jcrs->s_nippsetopexp }}'>
                                        </div>
                                        <div id='div_id_THP' class='mb-3'>
                                            <label for='id_THP' class='form-label'>
                                                THP
                                            </label>
                                            <input type='text' name='THP' placeholder='THP'
                                                class='textinput textInput form-control' id='id_THP'
                                                value='{{ old('THP') ? old('THP') : $jcrs->THP }}'>
                                        </div>
                                        <div id='div_id_maxDevAt' class='mb-3'>
                                            ...
                                            <input type='text' name='maxDevAt' placeholder='Max Dev at'
                                                ...
                                                value='{{ old('maxDevAt') ? old('maxDevAt') : $jcrs->maxDevAt }}'>
                                        </div>
                                        <div id='div_id_distTo_FroKms' class='mb-3'>
                                            ...
                                            <input type='text' name='distTo_FroKms' placeholder='Dist (To &amp; Fro) Kms.'
                                                ...
                                                value='{{ old('distTo_FroKms') ? old('distTo_FroKms') : $jcrs->distTo_FroKms }}'>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                    ...
                    <div class='d-flex'>
                                ...
                                <div class='form-card step'>
                                    ...
                                    <div id='div_id_mudType' class='mb-3'>
                                        ...
                                        <input type='text' name='mudType' placeholder='Mud Type' maxlength='20'
                                            ...
                                            value='{{ old('mudType') ? old('mudType') : $jcrs->mudType }}'>
                                    </div>
                                    <div id='div_id_rm' class='mb-3'>
                                        ...
                                        <input type='text' name='rm' placeholder='Rm' class='textinput textInput form-control'
                                            id='id_rm' value='{{ old('rm') ? old('rm') : $jcrs->rm }}'>
                                    </div>
                                    <div id='div_id_rmtemp' class='mb-3'>
                                        <label for='id_rmtemp' class='form-label'>
                                            Rm Temperature
                                        </label>
                                        <input type='text' name='rmtemp' placeholder='Rm Temp'
                                            class='textinput textInput form-control' id='id_rmtemp'
                                            value='{{ old('rmtemp') ? old('rmtemp') : $jcrs->rmtemp }}'>
                                    </div>
                                    <div id='div_id_rmf' class='mb-3'>
                                        ...
                                        <input type='text' name='rmf' placeholder='Rmf' class='textinput textInput form-control'
                                            id='id_rmf' value='{{ old('rmf') ? old('rmf') : $jcrs->rmf }}'>
                                    </div>
                                    <div id='div_id_rmftemp' class='mb-3'>
                                        ...
                                        <input type='text' name='rmftemp' placeholder='Rmf Temp'
                                            ...
                                            value='{{ old('rmftemp') ? old('rmftemp') : $jcrs->rmftemp }}'>
                                    </div>
                                    <div id='div_id_rmc' class='mb-3'>
                                        ...
                                        <input type='text' name='rmc' placeholder='Rmc' class='textinput textInput form-control'
                                            id='id_rmc' value='{{ old('rmc') ? old('rmc') : $jcrs->rmc }}'>
                                    </div>
                                    <div id='div_id_rmctemp' class='mb-3'>
                                        ...
                                        <input type='text' name='rmctemp' placeholder='Rmc Temp'
                                            ...
                                            value='{{ old('rmctemp') ? old('rmctemp') : $jcrs->rmctemp }}'>
                                    </div>
                                    <div id='div_id_bht' class='mb-3'>
                                        ...
                                        <input type='text' name='bht' placeholder='Bottom Hole Temp'
                                            ...
                                            value='{{ old('bht') ? old('bht') : $jcrs->bht }}'>
                                    </div>
                                    <div id='div_id_bhtdepth' class='mb-3'>
                                        ...
                                        <input type='text' name='bhtdepth' placeholder='BHT Depth'
                                            ...
                                            value='{{ old('bhtdepth') ? old('bhtdepth') : $jcrs->bhtdepth }}'>
                                    </div>
                                    <div id='div_id_spgr' class='mb-3'>
                                        <label for='id_spgr' class='form-label'>
                                            Sp. Gr. (gm/cc)
                                        </label>
                                        <input type='text' name='spgr' placeholder='Sp. Gr.'
                                            class='textinput textInput form-control' id='id_spgr'
                                            value='{{ old('spgr', $jcrs->spgr) }}'>
                                    </div>
                                    <div id='div_id_viscosity' class='mb-3'>
                                        ...
                                        <input type='text' name='viscosity' placeholder='Viscosity'
                                            ...
                                            value='{{ old('viscosity') ? old('viscosity') : $jcrs->viscosity }}'>
                                    </div>
                                    <div id='div_id_waterloss' class='mb-3'>
                                        ...
                                        <input type='text' name='waterloss' placeholder='Water Loss'
                                            ...
                                            value='{{ old('waterloss') ? old('waterloss') : $jcrs->waterloss }}'>
                                    </div>
                                    <div id='div_id_ph' class='mb-3'>
                                        ...
                                        <input type='text' name='ph' placeholder='PH' class='textinput textInput form-control'
                                            id='id_ph' value='{{ old('ph') ? old('ph') : $jcrs->ph }}'>
                                    </div>
                                    <div id='div_id_oilpercnt' class='mb-3'>
                                        <label for='id_oilpercnt' class='form-label'>
                                            Oil%
                                        </label>
                                        <input type='text' name='oilpercnt' placeholder='Oil%'
                                            class='textinput textInput form-control' id='id_oilpercnt'
                                            value='{{ old('oilpercnt') ? old('oilpercnt') : $jcrs->oilpercnt }}'>
                                    </div>
                                    <div id='div_id_kcl_barytes' class='mb-3'>
                                        ...
                                        <input type='text' name='kcl_barytes' placeholder='KCl/Barytes'
                                            ...
                                            value='{{ old('kcl_barytes') ? old('kcl_barytes') : $jcrs->kcl_barytes }}'>
                                    </div>
                                    <div id='div_id_salinity' class='mb-3'>
                                        ...
                                        <input type='text' name='salinity' placeholder='Salinity'
                                            ...
                                            value='{{ old('salinity', $jcrs->salinity) }}'>
                                    </div>
                                    <div id='div_id_lastcirc' class='mb-3'>
                                        <div class='d-flex'>
                                            <div class='container'>
                                                ...
                                                <input type='datetime' name='lastcirc_from' placeholder='YYYY-MM-DD HH:MM' data-mask='0000-00-00 00:00' class='datetimeinput form-control' id='id_lastcirc_from' autocomplete='off' value='{{ old('lastcirc_from', $jcrs->lastcirc_from) }}'>
                                            </div>
                                            <div class='container'>
                                                <label for='id_lastcirc_to' class='form-label'>
                                                    Last Circulation to
                                                </label>
                                                <input type='datetime' name='lastcirc_to' placeholder='YYYY-MM-DD HH:MM' data-mask='0000-00-00 00:00' class='datetimeinput form-control' id='id_lastcirc_to' autocomplete='off' value='{{ old('lastcirc_to', $jcrs->lastcirc_to) }}'>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <fieldset id='cableinfo'>
                                    <div class='form-card step'>
                                        ...
                                        <div id='div_id_cableSize' class='mb-3'>
                                            ...
                                            <select name='cableSize' type='text' placeholder='Cable Size'
                                                class='select form-select' id='id_cableSize'>
                                                <option value='' disabled selected>--- Select Cable Size ---</option>
                                                @foreach ($cableSizes as $cableSize)
                                                    <option value={{$cableSize}} {{ old('cableSize') == $cableSize || $jcrs->cableSize == $cableSize ? 'selected' : '' }}>
                                                        {{$cableSize}}</option>
                                                @endforeach
                                            </select>
                                            @error('cableSize')
                                        ...
                                        <div id='div_id_insulation' class='mb-3'>
                                            ...
                                            <input type='text' name='insulation' placeholder='Insulation'
                                                ...
                                                value='{{ old('insulation') ? old('insulation') : $jcrs->insulation }}'>
                                                @error('insulation')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_shoeDate' class='mb-3'>
                                            ...
                                            <input type='text' name='shoeDate' placeholder='YYYY-MM-DD' data-mask='0000-00-00'
                                                class='dateinput form-control' id='id_shoeDate' autocomplete='off'
                                                maxlength='10'
                                                value='{{ old('shoeDate') ? old('shoeDate') : date('Y-m-d', strtotime($jcrs->shoeDate)) }}'>
                                                @error('shoeDate')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_weakPoint' class='mb-3'>
                                            ...
                                            <input type='text' name='weakPoint' placeholder='[e.g. (OL+IL)]'
                                                ...
                                                value='{{ old('weakPoint') ? old('weakPoint') : $jcrs->weakPoint }}'>
                                                @error('weakPoint')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_cableHeadSize' class='mb-3'>
                                            ...
                                            <select type='text' name='cableHeadSize' placeholder='Cable Head Size'
                                                ...
                                                value='{{ old('cableHeadSize') ? old('cableHeadSize') : $jcrs->cableHeadSize }}'>
                                                <option value='' disabled selected>--- Select Cable Head Size ---</option>
                                                @foreach($cableHeadSizes as $cableHeadSize)
                                                    <option value='{{ $cableHeadSize }}' {{ old('cableHeadSize') == $cableHeadSize || $jcrs->cableHeadSize == $cableHeadSize ? 'selected' : '' }}>{{ $cableHeadSize }}</option>
                                                @endforeach
                                            </select>
                                            @error('cableHeadSize')
                                                <small class='error'>{{ $message }}</small>
                                        ...
                                        <div id='div_id_cableLength' class='mb-3'>
                                            ...
                                            <input type='text' name='cableLength' placeholder='Cable Length(m)'
                                                ...
                                                value='{{ old('cableLength') ? old('cableLength') : $jcrs->cableLength }}'>
                                                @error('cableLength')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_initialLength' class='mb-3'>
                                            ...
                                            <input type='text' name='initialLength' placeholder='Initial Cable Length(m)'
                                                ...
                                                value='{{ old('initialLength') ? old('initialLength') : $jcrs->initialLength }}'>
                                                @error('initialLength')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <fieldset id='surfaceequipment'>
                                    <div class='form-card step'>
                                        ...
                                        <div id='div_id_surfaceEquipment' class='mb-3'>
                                            <label for='id_surfaceEquipment' class='form-label requiredField'>Surface Equipment<span class='asteriskField'>*</span></label>
                                            <input type='text' name='surfaceEquipment' placeholder='Surface Equipment' class='textinput textInput form-control' id='id_surfaceEquipment' value='{{ old('surfaceEquipment') ? old('surfaceEquipment') : $jcrs->surfaceEquipment }}'>
                                                @error('surfaceEquipment')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_automobile' class='mb-3'>
                                            <label for='id_automobile' class='form-label requiredField'>Automobile<span class='asteriskField'>*</span></label>
                                            <input type='text' name='automobile' placeholder='Automobile' class='textinput textInput form-control' id='id_automobile' value='{{ old('automobile') ? old('automobile') : $jcrs->automobile }}'>
                                                @error('automobile')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_wellCondition' class='mb-3'>
                                            <label for='id_wellCondition' class='form-label requiredField'>Well Condition<span class='asteriskField'>*</span></label>
                                            <input type='text' name='wellCondition' placeholder='Well Condition' class='textinput textInput form-control' id='id_wellCondition' value='{{ old('wellCondition') ? old('wellCondition') : $jcrs->wellCondition }}'>
                                                @error('wellCondition')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_timeLoss' class='mb-3'>
                                            <label for='id_timeLoss' class='form-label requiredField'>Time Loss(Hr)<span class='asteriskField'>*</span></label>
                                            <input type='text' name='timeLoss' placeholder='Time Loss(Hr)' class='textinput textInput form-control' id='id_timeLoss' value='{{ old('timeLoss') ? old('timeLoss') : $jcrs->timeLoss }}'>
                                                @error('timeLoss')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                        ...
                        <fieldset id='personnel'>
                            <div class='form-card step' id='personnel-form'>
                                    ...
                                    @if (old('personnel'))
                                        @foreach (old('personnel') as $index=>$old_personnel)
                                            <div class='mb-3 element' id='userinlinemodel_{{ $index+1 }}'>
                                                <label for='select_{{ $index+1 }}' class='form-label requiredField' id='personnellabel_{{ $index+1 }}'>Personnel<span class='asteriskField' id='asterisk_{{ $index+1 }}'>*</span></label>
                                                    <select data-live-search='true' class='select form-select mb-3 personnelselect' id='select_{{ $index+1 }}' name='personnel[{{ $index }}][user_id]'>
                                                        <option value='' {{ old('personnel') == '' ? 'selected' : ''}}>--- Select Personnel ---</option>
                                        ...
                                        @endforeach
                                    @else
                                        @foreach ($jcrs->users as $index=>$jcrUser)
                                            <div class='mb-3 element' id='userinlinemodel_{{ $index+1 }}'>
                                                    <label for='select_{{ $index+1 }}' class='form-label requiredField' id='personnellabel_{{ $index+1 }}'>Personnel<span class='asteriskField' id='asterisk_1'>*</span> </label>
                                                    <select data-live-search='true' class='select form-select mb-3 personnelselect' id='select_{{ $index+1 }}' name='personnel[{{ $index }}][user_id]'>
                                                        <option value='' {{ old('personnel') == '' ? 'selected' : ''}}>--- Select Personnel ---</option>
                                                        @foreach ($users as $user)
                                                            <option value='{{ $user->id }}' {{ $jcrUser->id == $user->id? 'selected' : ''}}>{{ $user->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('personnel')
                                                        <small class='error'>{{ $message }}</small>
                                ...
                                <button class='btn btn-success btn-lg' id='add_more_personnel' type='button'><i class='fa fa-plus-circle'></i></button>
                                <div class='contingents'>
                                    <div id='div_id_contingents' class='mb-3'>
                                        ...
                                        <textarea name='contingents' cols='40' rows='10' type='text'
                                            ...
                                            id='id_contingents'>{{ old('contingents') ?  old('contingents') : $jcrs->contingents }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                                    ...
                                    <div class="logs-wrapper">
                                        @if (old('logrecorded'))
                                            @foreach (old('logrecorded') as $index=>$old_logrecorded)
                                                ...
                                                @else
                                                <hr class='my-3' style='color:#000000; border-top:5px solid; opacity:0.5;'><h2 class='my-2'>Run - {{ $index+1 }}</h2>
                                                @endif
                                                <input type="number" name="logrecorded[{{ $index }}][id]" hidden value="{{ $old_logrecorded['id'] }}">
                                                    <div id='div_logmodel_set-{{ $index+1 }}-runNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-runNo' class='form-label requiredField'>Run No.<span
                                                                class='asteriskField'>*</span> </label>
                                                        <input type='number' name='logrecorded[{{ $index }}][runNo]' class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-runNo' value='{{ $old_logrecorded['runNo']  }}'>
                                                        @error('logrecorded.*.runNo')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-logRecorded' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-logRecorded' class='form-label requiredField'>
                                                        ...
                                                        <input type='text' name='logrecorded[{{ $index }}][logRecorded]' maxlength='255'
                                                            class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-logRecorded' value='{{ $old_logrecorded['logRecorded'] }}'>
                                                        @error('logrecorded.*.logRecorded')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-bottomDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-bottomDepth' class='form-label requiredField'>
                                                            Bottom Depth(m)<span class='asteriskField'>*</span> </label> <input
                                                            type='number' name='logrecorded[{{ $index }}][bottomDepth]' step='any' class='numberinput form-control'
                                                            id='id_logmodel_set-{{ $index+1 }}-bottomDepth' value='{{ $old_logrecorded['bottomDepth'] }}'>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index+1 }}-topDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-topDepth' class='form-label requiredField'>
                                                            ...
                                                            <input type='number' name='logrecorded[{{ $index }}][topDepth]' step='any' class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-topDepth' value='{{ $old_logrecorded['topDepth'] }}'>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index+1 }}-toolNo' class='mb-3'>
                                                        ...
                                                        <input type='text' name='logrecorded[{{ $index }}][toolNo]' maxlength='255' class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-toolNo' value='{{ $old_logrecorded['toolNo'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-logQuality' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-logQuality' class='form-label requiredField'>
                                                            ...
                                                            <input type='text' name='logrecorded[{{ $index }}][logQuality]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-logQuality' value='{{ $old_logrecorded['logQuality'] }}'>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index+1 }}-bottomShotDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-bottomShotDepth' class='form-label'>
                                                            Bottom Shot Depth(m)
                                                        </label> <input type='number' name='logrecorded[{{ $index }}][bottomShotDepth]' step='any'
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-bottomShotDepth' value='{{ $old_logrecorded['bottomShotDepth'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-topShotDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-topShotDepth' class='form-label'>
                                                            ...
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-topShotDepth' value='{{ $old_logrecorded['topShotDepth'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-charge' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-charge' class='form-label'>Charge Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][charge]' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-charge' value='{{ $old_logrecorded['charge'] }}'>
                                                            <option value='' {{ $old_logrecorded['charge'] == '' ? 'selected' : '' }}>--- Select Charge type ---</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index +1 }}-chargeNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-chargeNo' class='form-label'>
                                                            Charge Qty.(Nos.)
                                                        </label> <input type='number' name='logrecorded[{{ $index }}][chargeNo]' class='numberinput form-control'
                                                            id='id_logmodel_set-{{ $index +1 }}-chargeNo' value='{{ $old_logrecorded['chargeNo'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-primaChord' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-primaChord' class='form-label'>Prima Chord Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][primaChord]' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-primaChord'>
                                                            <option value='' {{ $old_logrecorded['primaChord'] == '' ? 'selected' : '' }}>--- Select Prima Chord type ---</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index +1 }}-primaChordQty' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-primaChordQty' class='form-label'>
                                                            ...
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index +1 }}-primaChordQty' value='{{ $old_logrecorded['primaChordQty'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-fuse' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-fuse' class='form-label'>Fuse Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][fuse]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-fuse'>
                                                            <option value='' {{ $old_logrecorded['fuse'] == '' ? 'selected' : '' }}>--- Select Detonator type ---</option>
                                                            <option value='26FDE' {{ $old_logrecorded['fuse'] == '26FDE' ? 'selected' : '' }}>26FDE</option>
                                                            <option value='15FDE' {{ $old_logrecorded['fuse'] == '15FDE' ? 'selected' : '' }}>15FDE</option>
                                                            <option value='1015-E' {{ $old_logrecorded['fuse'] == '1015-E' ? 'selected' : '' }}>1015-E</option>
                                                            <option value='Z480' {{ $old_logrecorded['fuse'] == 'Z480' ? 'selected' : '' }}>Z480</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index+1 }}-fuseNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-fuseNo' class='form-label'>
                                                            Fuse Qty. (Nos.)
                                                        </label> <input type='number' name='logrecorded[{{ $index }}][fuseNo]' class='numberinput form-control'
                                                            id='id_logmodel_set-{{ $index+1 }}-fuseNo' value='{{ $old_logrecorded['fuseNo'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-fMf' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-fMf' class='form-label'>F/MF</label>
                                                        <select name='logrecorded[{{ $index }}][fMf]' class='select form-select' id='id_logmodel_set-{{ $index+1 }}-fMf'>
                                                            <option value='' {{ $old_logrecorded['fMf'] == '' ? 'selected' : ''}}>---------</option>
                                            ...
                                            @endforeach
                                        @elseif(!$jcrs->logs->isEmpty())
                                            @foreach($jcrs['logs'] as $index=>$logsrecorded)
                                                <div class='log-form' id='id-log-form_{{$index+1}}'>
                                                    @if ($index <= 0)
                                                        <h2 class='my-2'>Run - {{ $index+1 }}</h2>
                                                    @else
                                                    <hr class='my-3' style='color:#000000; border-top:5px solid; opacity:0.5;'><h2 class='my-2'>Run - {{ $index+1 }}</h2>
                                                    @endif
                                                    <input type="number" name="logrecorded[{{ $index }}][id]" hidden value="{{ $logsrecorded['id'] }}">
                                                    <div id='div_logmodel_set-{{$index+1}}-runNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{$index+1}}-runNo' class='form-label requiredField'>Run No.<span
                                                                class='asteriskField'>*</span> </label>
                                                        <input type='number' name='logrecorded[{{ $index }}][runNo]' class='numberinput form-control' id='id_logmodel_set-{{$index+1}}-runNo' value="{{ $logsrecorded->runNo }}">
                                                        @error('logrecorded.*.runNo')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-logRecorded' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-logRecorded' class='form-label requiredField'>
                                                            Type of Logs Recorded<span class='asteriskField'>*</span> </label>
                                                        <input type='text' name='logrecorded[{{ $index }}][logRecorded]' maxlength='255'
                                                            class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-logRecorded' value='{{ $logsrecorded->logRecorded }}'>
                                                        @error('logrecorded.*.logRecorded')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-bottomDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-bottomDepth' class='form-label requiredField'>
                                                            Bottom Depth(m)<span class='asteriskField'>*</span> </label> <input
                                                            type='number' name='logrecorded[{{ $index }}][bottomDepth]' step='any' class='numberinput form-control'
                                                            id='id_logmodel_set-{{ $index+1 }}-bottomDepth' value='{{ $logsrecorded->bottomDepth }}'>
                                                        @error('logrecorded.*.bottomDepth')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-topDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-topDepth' class='form-label requiredField'>
                                                            Top Depth(m)<span class='asteriskField'>*</span> </label>
                                                            <input type='number' name='logrecorded[{{ $index }}][topDepth]' step='any' class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-topDepth' value='{{ $logsrecorded->topDepth }}'>
                                                        @error('logrecorded.*.topDepth')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-toolNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-toolNo' class='form-label'>Tool No.</label>
                                                        <input type='text' name='logrecorded[{{ $index }}][toolNo]' maxlength='255' class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-toolNo' value='{{ $logsrecorded->toolNo }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-logQuality' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-logQuality' class='form-label requiredField'>
                                                            Log Quality<span class='asteriskField'>*</span> </label>
                                                            <input type='text' name='logrecorded[{{ $index }}][logQuality]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-{{ $index+1 }}-logQuality' value='{{ $logsrecorded->logQuality }}'>
                                                        @error('logrecorded.*.logQuality')
                                                            <small class='error'>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-bottomShotDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-bottomShotDepth' class='form-label'>
                                                            ...
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-bottomShotDepth' value='{{ $logsrecorded->bottomShotDepth }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-topShotDepth' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-topShotDepth' class='form-label'>
                                                            Top Shot Depth(m)
                                                        </label> <input type='number' name='logrecorded[{{ $index }}][topShotDepth]' step='any'
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index+1 }}-topShotDepth' value='{{ $logsrecorded->topShotDepth }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-charge' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-charge' class='form-label'>Charge Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][charge]' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-charge'>
                                                            <option value='' {{ $logsrecorded['charge'] == '' ? 'selected' : '' }}>--- Select Charge type ---</option>
                                                            ...
                                                            <option value='8gm TTP' {{ $logsrecorded['charge'] == '8gm TTP' ? 'selected' : '' }}>8gm TTP</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index +1 }}-chargeNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-chargeNo' class='form-label'>
                                                            ...
                                                            id='id_logmodel_set-{{ $index +1 }}-chargeNo' value='{{ $logsrecorded['chargeNo'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-primaChord' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-primaChord' class='form-label'>Prima Chord Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][primaChord]' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-primaChord'>
                                                            <option value='' {{ $logsrecorded['primaChord'] == '' ? 'selected' : '' }}>--- Select Prima Chord type ---</option>
                                                            <option value='T-150' {{ $logsrecorded['primaChord'] == 'T-150' ? 'selected' : '' }}>T-150</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index +1 }}-primaChordQty' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-primaChordQty' class='form-label'>
                                                            ...
                                                            class='numberinput form-control' id='id_logmodel_set-{{ $index +1 }}-primaChordQty' value='{{ $logsrecorded['primaChordQty'] }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index +1 }}-fuse' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index +1 }}-fuse' class='form-label'>Fuse Type</label>
                                                        <select type='text' name='logrecorded[{{ $index }}][fuse]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-{{ $index +1 }}-fuse'>
                                                            <option value='' {{ $logsrecorded['fuse'] == '' ? 'selected' : '' }}>--- Select Detonator type ---</option>
                                                            <option value='26FDE' {{ $logsrecorded['fuse'] == '26FDE' ? 'selected' : '' }}>26FDE</option>
                                                            <option value='15FDE' {{ $logsrecorded['fuse'] == '15FDE' ? 'selected' : '' }}>15FDE</option>
                                                            <option value='1015-E' {{ $logsrecorded['fuse'] == '1015-E' ? 'selected' : '' }}>1015-E</option>
                                                            <option value='Z480' {{ $logsrecorded['fuse'] == 'Z480' ? 'selected' : '' }}>Z480</option>
                                                    ...
                                                    <div id='div_logmodel_set-{{ $index+1 }}-fuseNo' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-fuseNo' class='form-label'>
                                                            ...
                                                            id='id_logmodel_set-{{ $index+1 }}-fuseNo' value='{{ $logsrecorded->fuseNo }}'>
                                                    </div>
                                                    <div id='div_logmodel_set-{{ $index+1 }}-fMf' class='mb-3'>
                                                        <label for='id_logmodel_set-{{ $index+1 }}-fMf' class='form-label'>F/MF</label>
                                                        <select name='logrecorded[{{ $index }}][fMf]' class='select form-select' id='id_logmodel_set-{{ $index+1 }}-fMf'>
                                            ...
                                            <div class='log-form' id='id-log-form_1'>
                                                <div id='div_logmodel_set-1-runNo' class='mb-3'>
                                                    <label for='id_logmodel_set-1-runNo' class='form-label requiredField'>Run No.<span
                                                            class='asteriskField'>*</span> </label>
                                                    <input type='number' name='logrecorded[0][runNo]' class='numberinput form-control' id='id_logmodel_set-1-runNo' value="">
                                                    @error('logrecorded.*.runNo')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-logRecorded' class='mb-3'>
                                                    ...
                                                    <input type='text' name='logrecorded[0][logRecorded]' maxlength='255'
                                                        class='textinput textInput form-control' id='id_logmodel_set-1-logRecorded' value=''>
                                                    @error('logrecorded.*.logRecorded')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-bottomDepth' class='mb-3'>
                                                    <label for='id_logmodel_set-1-bottomDepth' class='form-label requiredField'>
                                                        Bottom Depth(m)<span class='asteriskField'>*</span> </label> <input
                                                        type='number' name='logrecorded[0][bottomDepth]' step='any' class='numberinput form-control'
                                                ...
                                                <div id='div_logmodel_set-1-topDepth' class='mb-3'>
                                                    <label for='id_logmodel_set-1-topDepth' class='form-label requiredField'>
                                                        Top Depth(m)<span class='asteriskField'>*</span> </label>
                                                        <input type='number' name='logrecorded[0][topDepth]' step='any' class='numberinput form-control' id='id_logmodel_set-1-topDepth' value=''>
                                                    @error('logrecorded.*.topDepth')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-toolNo' class='mb-3'>
                                                    ...
                                                    <input type='text' name='logrecorded[0][toolNo]' maxlength='255' class='textinput textInput form-control' id='id_logmodel_set-1-toolNo' value=''>
                                                </div>
                                                <div id='div_logmodel_set-1-logQuality' class='mb-3'>
                                                    <label for='id_logmodel_set-1-logQuality' class='form-label requiredField'>
                                                        Log Quality<span class='asteriskField'>*</span> </label>
                                                        <input type='text' name='logrecorded[0][logQuality]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-1-logQuality' value=''>
                                                    @error('logrecorded.*.logQuality')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                ...
                                                <div id='div_logmodel_set-1-charge' class='mb-3'>
                                                    ...
                                                    <select type='text' name='logrecorded[0][charge]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-1-charge'>
                                                ...
                                                <div id='div_logmodel_set-1-chargeNo' class='mb-3'>
                                                    <label for='id_logmodel_set-1-chargeNo' class='form-label'>
                                                        Charge Qty.(Nos.)
                                                    </label> <input type='number' name='logrecorded[0][chargeNo]' class='numberinput form-control'
                                                        id='id_logmodel_set-1-chargeNo' value='{{ old('chargeNo') }}'>
                                                </div>
                                                <div id='div_logmodel_set-1-primaChord' class='mb-3'>
                                                    ...
                                                    <select type='text' name='logrecorded[0][primaChord]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-1-primaChord'>
                                                ...
                                                <div id='div_logmodel_set-1-primaChordQty' class='mb-3'>
                                                    <label for='id_logmodel_set-1-primaChordQty' class='form-label'>
                                                        ...
                                                        class='numberinput form-control' id='id_logmodel_set-1-primaChordQty' value='{{ old('primaChordQty') }}'>
                                                </div>
                                                <div id='div_logmodel_set-1-fuse' class='mb-3'>
                                                    <label for='id_logmodel_set-1-fuse' class='form-label'>Fuse Type</label>
                                                    <select type='text' name='logrecorded[0][fuse]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-1-fuse'>
                                                ...
                                                <div id='div_logmodel_set-1-fuseNo' class='mb-3'>
                                                    <label for='id_logmodel_set-1-fuseNo' class='form-label'>
                                                        Fuse Qty. (Nos.)
                                                    </label> <input type='number' name='logrecorded[0][fuseNo]' class='numberinput form-control'
                                                        id='id_logmodel_set-1-fuseNo' value=''>
                                                </div>
                                                <div id='div_logmodel_set-1-fMf' class='mb-3'>
                                                    <label for='id_logmodel_set-1-fMf' class='form-label'>F/MF</label>
                                                    <select name='logrecorded[0][fMf]' class='select form-select' id='id_logmodel_set-1-fMf'>
                                                ...
                                                @foreach (old('explosive') as $index=>$old_explosive)
                                                    <div class='explosive-form' id='id-explosive-form_{{ $index+1 }}'>
                                                        ...
                                                        @if (isset($old_explosive['id']))
                                                            <input type="number" name="explosive[{{ $index }}][id]" hidden value="{{ $old_explosive['id'] }}">
                                                        @endif
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-explosives' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-explosives' class='form-label'>Charges</label>
                                                            <select name='explosive[{{ $index }}][explosive]' type='text' placeholder='--- Select Charge type ---' class='select form-select' id='id_explosive_set-{{ $index+1 }}-explosives'>
                                                                <option value='' {{ $old_explosive['explosive'] == '' ? 'selected' : '' }}>--- Select Charge type ---</option>
                                                        ...
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-issued' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-issued' class='form-label'> Charge Issued</label>
                                                            <input type='text' name='explosive[{{ $index }}][issued]' placeholder='Issued' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-issued'  value="{{ $old_explosive['issued'] }}">
                                                        </div>
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-used' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-used' class='form-label'>Charge Used</label>
                                                            <input type='text' name='explosive[{{ $index }}][used]' placeholder='Used' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-used' value="{{ $old_explosive['used'] }}">
                                                        </div>
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-returned' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-returned' class='form-label'>Charge Returned</label>
                                                            <input type='text' name='explosive[{{ $index }}][returned]' placeholder='Returned' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-returned' value="{{ $old_explosive['returned'] }}">
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @elseif(!$jcrs->explosives->isEmpty())
                                                @foreach ($jcrs->explosives as $index=>$jcrExplosive )
                                                    <div class='explosive-form' id='id-explosive-form_{{ $index+1 }}'>
                                                        <h2 class='my-3'>Explosive - {{ $index+1 }}</h2>
                                                        <input type="number" name="explosive[{{ $index }}][id]" hidden value="{{ $jcrExplosive['id'] }}">
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-explosives' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-explosives' class='form-label'>Charges</label>
                                                            <select name='explosive[{{ $index }}][explosive]' type='text' placeholder='--- Select Charge type ---' class='select form-select' id='id_explosive_set-{{ $index+1 }}-explosives'>
                                                                <option value='' {{ $jcrExplosive['explosive'] == '' ? 'selected' : '' }}>--- Select Charge type ---</option>
                                                                ...
                                                                <option value='Z480' {{ $jcrExplosive['explosive'] == 'Z480' ? 'selected' : '' }}>Z480</option>
                                                        ...
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-issued' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-issued' class='form-label'> Charge Issued</label>
                                                            <input type='text' name='explosive[{{ $index }}][issued]' placeholder='Issued' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-issued' value="{{ $jcrExplosive->issued }}">
                                                        </div>
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-used' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-used' class='form-label'>Charge Used</label>
                                                            <input type='text' name='explosive[{{ $index }}][used]' placeholder='Used' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-used' value="{{ $jcrExplosive->used }}">
                                                        </div>
                                                        <div id='div_id_explosive_set-{{ $index+1 }}-returned' class='mb-3'>
                                                            <label for='id_explosive_set-{{ $index+1 }}-returned' class='form-label'>Charge Returned</label>
                                                            <input type='text' name='explosive[{{ $index }}][returned]' placeholder='Returned' class='textinput textInput form-control' id='id_explosive_set-{{ $index+1 }}-returned' value="{{ $jcrExplosive->returned }}">
                                                        </div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div class='explosive-form' id='id-explosive-form_1'>
                                                    ...
                                                    <div id='div_id_explosive_set-1-explosives' class='mb-3'>
                                                        ...
                                                        <select name='explosive[0][explosive]' type='text' placeholder='--- Select Charge type ---' class='select form-select' id='id_explosive_set-1-explosives'>
                                                                <option value=''  >--- Select Charge type ---</option>
                                                                <option value='25gm TAG' >25gm TAG</option>
                                                                <option value='23gm TAG' >23gm TAG</option>
                                                                <option value='8gm TTP' >8gm TTP</option>
                                                    ...
                                                    <div id='div_id_explosive_set-1-issued' class='mb-3'>
                                                        ...
                                                        <input type='text' name='explosive[0][issued]' placeholder='Issued' class='textinput textInput form-control' id='id_explosive_set-1-issued' >
                                                    </div>
                                                    <div id='div_id_explosive_set-1-used' class='mb-3'>
                                                        <label for='id_explosive_set-1-used' class='form-label'>Charge Used</label>
                                                        <input type='text' name='explosive[0][used]' placeholder='Used' class='textinput textInput form-control' id='id_explosive_set-1-used'>
                                                    </div>
                                                    <div id='div_id_explosive_set-1-returned' class='mb-3'>
                                                        ...
                                                        <input type='text' name='explosive[0][returned]' placeholder='Returned' class='textinput textInput form-control' id='id_explosive_set-1-returned'>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                ...
                <div class='container-fluid pb-3 form-step' style='display: none; position: relative; opacity: 0;'>
                                ...
                                <div class='form-card step'>
                                    ...
                                    <div id='div_id_permitType' class='mb-3'>
                                        <label for='id_permitType' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('permitType') == '' || $jcrs->permitType == '' ? 'selected' : ''}}>--- Select Permit Type ---</option>
                                            <option value='Cold Work Permit' {{ old('permitType') == 'Cold Work Permit' || $jcrs->permitType == 'Cold Work Permit' ? 'selected' : 'selected'}}>Cold Work Permit</option>
                                            <option value='Hot Work Permit' {{ old('permitType') == 'Hot Work Permit' || $jcrs->permitType == 'Hot Work Permit' ? 'selected' : ''}}>Hot Work Permit</option>
                                            <option value='NA' {{ old('permitType') == 'NA' || $jcrs->permitType == 'NA'? 'selected' : ''}}>Not Applicable</option>
                                        </select>
                                        @error('permitType')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_permitNo' class='mb-3'>
                                        ...
                                        <input type='text' name='permitNo' placeholder='Work Permit No.'
                                            class='textinput textInput form-control' id='id_permitNo' value={{ old('permitNo') ? old('permitNo') : $jcrs->permitNo }}>
                                    </div>
                                    <div id='div_id_permitWork' class='mb-3'>
                                        <label for='id_permitWork' class='form-label requiredField'>
                                            ...
                                            <option value=''  {{ old('permitWork') == '' || $jcrs->permitWork == '' ? 'selected' : ''}}>--- Select Form of permit to work ---</option>
                                            <option value='1'  {{ old('permitWork') == '1' || $jcrs->permitWork == '1' ? 'selected' : 'selected'}}>Yes</option>
                                            <option value='0'  {{ old('permitWork') == '0' || $jcrs->permitWork == '0' ? 'selected' : ''}}>No</option>
                                        </select>
                                        @error('permitWork')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_elecLockout' class='mb-3' style='display: none;'>
                                        <label for='id_elecLockout' class='form-label'>
                                            ...
                                            <option value=''  {{ old('elecLockout') == '' || $jcrs->elecLockout == ''? 'selected' : ''}}>--- Select Electrical Lock out ---</option>
                                            <option value='1'  {{ old('elecLockout') == '1' || $jcrs->elecLockout == '1'? 'selected' : ''}}>Yes</option>
                                            <option value='0'  {{ old('elecLockout') == '0' || $jcrs->elecLockout == '0'? 'selected' : ''}}>No</option>
                                        </select>
                                    </div>
                                    <div id='div_id_elecLockoutNo' class='mb-3' style='display: none;'>
                                        ...
                                        <input type='text' name='elecLockoutNo' placeholder='Electrical Lock out No.'
                                            class='textinput textInput form-control' id='id_elecLockoutNo' value='{{ old('elecLockoutNo') ? old('elecLockoutNo') : $jcrs->elecLockoutNo }}'>
                                    </div>
                                    <div id='div_id_safetyMeeting' class='mb-3'>
                                        <label for='id_safetyMeeting' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('safetyMeeting') == '' || $jcrs->safetyMeeting == '' ? 'selected' : ''}}>--- Select Safety Meeting conducted ---</option>
                                            <option value='1' {{ old('safetyMeeting') == '1' || $jcrs->safetyMeeting == '1' ? 'selected' : 'selected'}}>Yes</option>
                                            <option value='0' {{ old('safetyMeeting') == '0' || $jcrs->safetyMeeting == '0' ? 'selected' : ''}}>No</option>
                                        </select>
                                        @error('safetyMeeting')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_jobCloseMeeting' class='mb-3'>
                                        <label for='id_jobCloseMeeting' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('jobCloseMeeting') =='' || $jcrs->jobCloseMeeting == '' ? 'selected' : '' }}>--- Select Job Close up Meeting ---</option>
                                            <option value='1' {{ old('jobCloseMeeting') =='1' || $jcrs->jobCloseMeeting == '1' ? 'selected' : 'selected' }}>Yes</option>
                                            <option value='0' {{ old('jobCloseMeeting') =='0' || $jcrs->jobCloseMeeting == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div id='div_id_nearMiss' class='mb-3'>
                                        ...
                                        </label><select name='nearMiss' type='text' placeholder='Near Miss'
                                            class='select form-select' id='id_nearMiss'>
                                            <option value='' {{ old('nearMiss') =='' || $jcrs->nearMiss == '' ? 'selected' : '' }}>--- Select Near Miss ---</option>
                                            <option value='1' {{ old('nearMiss') =='1' || $jcrs->nearMiss == '1' ? 'selected' : '' }}>Yes</option>
                                            <option value='0' {{ old('nearMiss') =='0' || $jcrs->nearMiss == '0' ? 'selected' : 'selected' }}>No</option>
                                        </select>
                                        @error('nearMiss')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_nearMissDesc' class='mb-3' style='display: none;'>
                                        ...
                                        <textarea name='nearMissDesc' cols='40' rows='10' type='text'
                                            ...
                                            id='id_nearMissDesc' value=''>{{ old('nearMissDesc') ? old('nearMissDesc') : $jcrs->nearMissDesc }}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                            ...
                            <fieldset id='jobstatus'>
                                <div class='form-card step'>
                                    ...
                                    <div id='div_id_jobStatus' class='mb-3'>
                                        ...
                                        </label><select name='jobStatus' type='text' placeholder='Job Status'
                                            class='select form-select' id='id_jobStatus'>
                                            <option value='' {{ old('jobStatus') =='' || $jcrs->jobStatus == '' ? 'selected' : '' }}>--- Select Job Status ---</option>
                                            <option value='Complete' {{ old('jobStatus') =='Complete' || $jcrs->jobStatus == 'Complete' ? 'selected' : 'selected' }}>Complete</option>
                                            <option value='Incomplete' {{ old('jobStatus') =='Incomplete' || $jcrs->jobStatus == 'Incomplete' ? 'selected' : '' }}>Incomplete</option>
                                            <option value='Continued' {{ old('jobStatus') =='Continued' || $jcrs->jobStatus == 'Continued' ? 'selected' : '' }}>Continued</option>
                                            <option value='Well Problem' {{ old('jobStatus') =='Well Problem' || $jcrs->jobStatus == 'Well Problem' ? 'selected' : '' }}>Well Problem</option>
                                            <option value='Not Feasible' {{ old('jobStatus') =='Not Feasible' || $jcrs->jobStatus == 'Not Feasible' ? 'selected' : '' }}>Not Feasible</option>
                                        </select>
                                        @error('jobStatus')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_remarks' class='mb-3'>
                                        ...
                                        <textarea name='remarks' cols='40' rows='10' type='text' placeholder='Remarks'
                                            class='textarea form-control' id='id_remarks'>{{ old('remarks') ? old('remarks') : $jcrs->remarks}}</textarea>
                                            @error('remarks')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    </div>
                                    <div id='div_id_objective' class='mb-3' style='display: none;'>
                                        ...
                                        <textarea name='objective' cols='40' rows='10' type='text'
                                            placeholder='Write the objective of PL' class='textarea form-control'
                                            id='id_objective' value=''>{{ old('objective') ? old('objective') : $jcrs->objective}}</textarea>
                                    </div>
                                    <div id='div_id_observations' class='mb-3' style='display: none;'>
                                        ...
                                        <textarea name='observations' cols='40' rows='10' type='text'
                                            placeholder='Write the Observations/Findings from this PL'
                                            class='textarea form-control' id='id_observations' value=''>{{ old('observations') ? old('observations') : $jcrs->observations}}</textarea>
                                    </div>
                                    <div id="div_id_final_submit" class="mb-3">
                                        <input class="m-2 p-2" type="checkbox" id="id_final_submit" name="final_submitted" value=1 {{ $jcrs->final_submitted == 1 ? 'checked' : '' }} required style="width: auto">
                                        <label class="form-label" for="id_final_submit" style="color: #000000">Final Submit</label>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                    ...
                    <button type='button' name='previous' class='previous btn btn-secondary'>Previous</button>
                    <button id='addupdate' type='submit' name='next' class='submit btn btn-success' value='Submit'>Submit</button>
                </div>
            </form>
        </div>
    </div>
