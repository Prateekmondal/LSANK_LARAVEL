        ...
        <div class="container h-100 d-flex align-items-center position-relative" style="z-index: 5;">
            <div class="row w-100">
                <div class="col-md-6 text-white">
                    <h1 class="display-4 fw-bold mb-4">Well Logging Services, {{ ucfirst(tenant()->name) }}</h1>
                    <p class="lead mb-4">Providing accurate and reliable borehole data collection and analysis for over 60
                        years in {{ ucfirst(tenant()->name) }} and surrounding regions.</p>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Server-passed aggregated stats for this tenant
            const initialStats = {!! json_encode($aggregatedStats ?? ['loggingType' => ['Open Hole Logging' => 180, 'Cased Hole Logging' => 780, 'Production Logging' => 50], 'owner' => ['Departmental' => 750, 'Contractual' => 250]]) !!};
            ...
            const jobStatsData = {
                ...
                datasets: [{
                    data: [
                        initialStats.loggingType['OH'] || 0,
                        initialStats.loggingType['CH'] || 0,
                        initialStats.loggingType['PL'] || 0,
                    ],
                    backgroundColor: [
                        '#3498db',
                        '#2ecc71',
            ...
            const jobStatsDatabar = {
                ...
                datasets: [{
                    data: [
                        initialStats.owner['departmental'] || 0,
                        initialStats.owner['contractual'] || 0,
                    ],
                    backgroundColor: [
                        '#3498db',
                        '#2ecc71'
            ...
            const chartLegend = document.getElementById('chartLegendpie');
