...
@section('content')
    ...
    <div class='container-fluid px-0' id='grad1'>
        <div class='container px-0 pt-3 pb-0 mt-3 mb-3 text-center bg-white'>
            ...
            <form id='msform' action='{{ route('jcr.save') }}' method='POST'>
                @csrf
                                    ...
                                    <div class='form-card step w-20'>
                                        ...
                                        <div id='div_id_loggingType' class='mb-3'>
                                            ...
                                            <select name='loggingType' type='text' placeholder='Logging Type'
                                                ...
                                                <option value='' selected disabled {{ old('loggingType') == '' ? 'selected' : ''}}>--- Select Logging Type ---</option>';
                                        ...
                                        <div id='div_id_kb' class='mb-3'>
                                            ...
                                            <input type='text' name='kb' placeholder='KB'
                                                class='textinput textInput form-control' id='id_kb' value='{{ old('kb') }}'>
                                            @error('kb')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_gl' class='mb-3'>
                                            ...
                                            <input type='text' name='gl' placeholder='GL'
                                                class='textinput textInput form-control' id='id_gl' value='{{ old('gl') }}'>
                                            @error('gl')
                                            <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_wellOwner' class='mb-3'>
                                            ...
                                            <select name='wellOwner' type='text' placeholder='Well Owner'
                                                ...
                                                @foreach ($wellOwners as $wellOwner)
                                                    <option value='{{ $wellOwner }}' {{ old('wellOwner') == $wellOwner ? 'selected' : '' }}>{{ $wellOwner }}</option>
                                                @endforeach
                                            </select>
                                            @error('wellOwner')
                                            <small class='error'>{{ $message }}</small>
                                    ...
                                    <div class='form-card step'>
                                        ...
                                        <div id='div_id_preparationTime' class='mb-3'>
                                            ...
                                            <input type='text' name='preparationTime'
                                                ...
                                                value='{{ old('preparationTime') ? old('preparationTime') : '1.0' }}'>
                                        ...
                                        <div id='div_id_postProceTime' class='mb-3'>
                                            ...
                                            <input type='text' name='postProceTime'
                                                ...
                                                value='{{ old('postProceTime') ? old('postProceTime') : '1.0' }}'>
                                            @error('postProceTime')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <fieldset id='surfaceequipment'>
                                    <div class='form-card step'>
                                        ...
                                        <div id='div_id_surfaceEquipment' class='mb-3'>
                                            ...
                                            <input type='text' name='surfaceEquipment' placeholder='Surface Equipment' class='textinput textInput form-control' id='id_surfaceEquipment' value='{{ old('surfaceEquipment') ? old('surfaceEquipment') : 'OK' }}'>
                                        ...
                                        <div id='div_id_automobile' class='mb-3'>
                                            ...
                                            <input type='text' name='automobile' placeholder='Automobile' class='textinput textInput form-control' id='id_automobile' value='{{ old('automobile') ? old('automobile') : 'OK' }}'>
                                                @error('automobile')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_wellCondition' class='mb-3'>
                                            ...
                                            <input type='text' name='wellCondition' placeholder='Well Condition' class='textinput textInput form-control' id='id_wellCondition' value='{{ old('wellCondition') ? old('wellCondition') : 'OK' }}'>
                                                @error('wellCondition')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div id='div_id_timeLoss' class='mb-3'>
                                            ...
                                            <input type='text' name='timeLoss' placeholder='Time Loss(Hr)' class='textinput textInput form-control' id='id_timeLoss' value='{{ old('timeLoss') ? old('timeLoss') : 'NO' }}'>
                                                @error('timeLoss')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                        </div>
                            ...
                            <div class='form-card step' id='personnel-form'>
                                ...
                                <div id='wrapper'>
                                    ...
                                    <div class='mb-3 element' id='userinlinemodel_1'>
                                            <label for='select_1' class='form-label requiredField' id='personnellabel_1'>Personnel<span class='asteriskField' id='asterisk_1'>*</span> </label>
                                                <select data-live-search='true' class='select form-select mb-3 personnelselect' id='select_1' name='personnel[0][user_id]'>
                                                    <option value='' {{ old('personnel') == '' ? 'selected' : ''}}>--- Select Personnel ---</option>
                                                    @foreach ($users->sortBy('seniority') as $user)
                                            ...
                                            <div class='log-form' id='id-log-form_1'>
                                                <div id='div_logmodel_set-1-runNo' class='mb-3'>
                                                    <label for='id_logmodel_set-1-runNo' class='form-label requiredField'>Run No.<span
                                                            class='asteriskField'>*</span> </label>
                                                    <input type='number' name='logrecorded[0][runNo]' class='numberinput form-control' id='id_logmodel_set-1-runNo' value='1'>
                                                    @error('logrecorded.*.runNo')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-logRecorded' class='mb-3'>
                                                    <label for='id_logmodel_set-1-logRecorded' class='form-label requiredField'>
                                                        Type of Logs Recorded<span class='asteriskField'>*</span> </label>
                                                    <select type='text' name='logrecorded[0][logRecorded]' class='textinput textInput form-control logsRecorded' id='id_logmodel_set-1-logRecorded' value='{{ old('logRecorded') }}'>
                                                    ...
                                                    <label class="logmodel_set-logRecorded-other" for="id_logmodel_set-1-logRecorded-other">Please specify:</label>
                                                    <input type='text' name='logrecorded[0][logRecorded]' maxlength='255'
                                                    class='textinput textInput form-control logmodel_set-logRecorded-other' id='id_logmodel_set-1-logRecorded-other' value='{{ old('logRecorded') }}'>
                                                    @error('logrecorded.*.logRecorded')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-bottomDepth' class='mb-3'>
                                                    <label for='id_logmodel_set-1-bottomDepth' class='form-label requiredField'>
                                                        ...
                                                        id='id_logmodel_set-1-bottomDepth' value='{{ old('bottomDepth') }}'>
                                                    @error('logrecorded.*.bottomDepth')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-topDepth' class='mb-3'>
                                                    <label for='id_logmodel_set-1-topDepth' class='form-label requiredField'>
                                                        Top Depth(m)<span class='asteriskField'>*</span> </label>
                                                        <input type='number' name='logrecorded[0][topDepth]' step='any' class='numberinput form-control' id='id_logmodel_set-1-topDepth' value='{{ old('topDepth') }}'>
                                                    @error('logrecorded.*.topDepth')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-toolNo' class='mb-3'>
                                                    ...
                                                    <input type='text' name='logrecorded[0][toolNo]' maxlength='255' class='textinput textInput form-control' id='id_logmodel_set-1-toolNo' value='{{ old('toolNo') }}'>
                                                </div>
                                                <div id='div_logmodel_set-1-logQuality' class='mb-3'>
                                                    <label for='id_logmodel_set-1-logQuality' class='form-label requiredField'>
                                                        Log Quality<span class='asteriskField'>*</span> </label>
                                                        <input type='text' name='logrecorded[0][logQuality]' maxlength='20' class='textinput textInput form-control' id='id_logmodel_set-1-logQuality' value='{{ old('logQuality') }}'>
                                                    @error('logrecorded.*.logQuality')
                                                        <small class='error'>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div id='div_logmodel_set-1-bottomShotDepth' class='mb-3 explosive-job d-none'>
                                                    <label for='id_logmodel_set-1-bottomShotDepth' class='form-label'>
                                                        ...
                                                        class='numberinput form-control' id='id_logmodel_set-1-bottomShotDepth' value='{{ old('bottomShotDepth') }}'>
                                                </div>
                                                <div id='div_logmodel_set-1-topShotDepth' class='mb-3 explosive-job d-none'>
                                                    <label for='id_logmodel_set-1-topShotDepth' class='form-label'>
                                                        ...
                                                        class='numberinput form-control' id='id_logmodel_set-1-topShotDepth' value='{{ old('topShotDepth') }}'>
                                                </div>
                                                ...
                                                <div id='div_logmodel_set-1-fuseNo' class='mb-3 explosive-job d-none'>
                                                    <label for='id_logmodel_set-1-fuseNo' class='form-label'>
                                                        ...
                                                        id='id_logmodel_set-1-fuseNo' value='{{ old('fuseNo') }}'>
                                                </div>
                                                <div id='div_logmodel_set-1-fMf' class='mb-3 explosive-job d-none'>
                                                    ...
                                                    <select name='logrecorded[0][fMf]' class='select form-select' id='id_logmodel_set-1-fMf'>
                                                        <option value='' {{ old('fMf') == '' ? 'selected' : ''}}>---------</option>
                                ...
                                <div class='form-card step'>
                                    ...
                                    <div id='div_id_permitType' class='mb-3'>
                                        <label for='id_permitType' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('permitType') == '' ? 'selected' : ''}}>--- Select Permit Type ---</option>
                                            <option value='Cold Work Permit' {{ old('permitType') == 'Cold Work Permit' ? 'selected' : 'selected'}}>Cold Work Permit</option>
                                            <option value='Hot Work Permit' {{ old('permitType') == 'Hot Work Permit' ? 'selected' : ''}}>Hot Work Permit</option>
                                            <option value='NA' {{ old('permitType') == 'NA' ? 'selected' : ''}}>Not Applicable</option>
                                        </select>
                                        @error('permitType')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_permitWork' class='mb-3'>
                                        <label for='id_permitWork' class='form-label requiredField'>
                                            ...
                                            <option value=''  {{ old('permitWork') == '' ? 'selected' : ''}}>--- Select Form of permit to work ---</option>
                                            <option value='1'  {{ old('permitWork') == '1' ? 'selected' : 'selected'}}>Yes</option>
                                    ...
                                    <div id='div_id_elecLockout' class='mb-3' style='display: none;'>
                                        <label for='id_elecLockout' class='form-label'>
                                            ...
                                            <option value=''  {{ old('elecLockout') == '' ? 'selected' : ''}}>--- Select Electrical Lock out ---</option>
                                    ...
                                    <div id='div_id_elecLockoutNo' class='mb-3' style='display: none;'>
                                        ...
                                        <input type='text' name='elecLockoutNo' placeholder='Electrical Lock out No.'
                                            class='textinput textInput form-control' id='id_elecLockoutNo' value='{{ old('elecLockoutNo') }}'>
                                    </div>
                                    <div id='div_id_safetyMeeting' class='mb-3'>
                                        <label for='id_safetyMeeting' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('safetyMeeting') == '' ? 'selected' : ''}}>--- Select Safety Meeting conducted ---</option>
                                            <option value='1' {{ old('safetyMeeting') == '1' ? 'selected' : 'selected'}}>Yes</option>
                                    ...
                                    <div id='div_id_jobCloseMeeting' class='mb-3'>
                                        <label for='id_jobCloseMeeting' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('jobCloseMeeting') =='' ? 'selected' : '' }}>--- Select Job Close up Meeting ---</option>
                                            <option value='1' {{ old('jobCloseMeeting') =='1' ? 'selected' : 'selected' }}>Yes</option>
                                            <option value='0' {{ old('jobCloseMeeting') =='0' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div id='div_id_nearMiss' class='mb-3'>
                                        <label for='id_nearMiss' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('nearMiss') =='' ? 'selected' : '' }}>--- Select Near Miss ---</option>
                                            <option value='1' {{ old('nearMiss') =='1' ? 'selected' : '' }}>Yes</option>
                                            <option value='0' {{ old('nearMiss') =='0' ? 'selected' : 'selected' }}>No</option>
                                        </select>
                                        @error('nearMiss')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                ...
                                <div class='form-card step'>
                                    ...
                                    <div id='div_id_jobStatus' class='mb-3'>
                                        <label for='id_jobStatus' class='form-label requiredField'>
                                            ...
                                            <option value='' {{ old('jobStatus') =='' ? 'selected' : '' }}>--- Select Job Status ---</option>
                                            <option value='Complete' {{ old('jobStatus') =='Complete' ? 'selected' : 'selected' }}>Complete</option>
                                            <option value='Incomplete' {{ old('jobStatus') =='Incomplete' ? 'selected' : '' }}>Incomplete</option>
                                            <option value='Continued' {{ old('jobStatus') =='Continued' ? 'selected' : '' }}>Continued</option>
                                            <option value='Well Problem' {{ old('jobStatus') =='Well Problem' ? 'selected' : '' }}>Well Problem</option>
                                            <option value='Not Feasible' {{ old('jobStatus') =='Not Feasible' ? 'selected' : '' }}>Not Feasible</option>
                                        </select>
                                        @error('jobStatus')
                                                <small class='error'>{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div id='div_id_objective' class='mb-3' style='display: none;'>
                                        ...
                                        <textarea name='objective' cols='40' rows='10' type='text'
                                            ...
                                            id='id_objective' value=''>{{ old('objective') }}</textarea>
                                    </div>
                                    <div id='div_id_observations' class='mb-3' style='display: none;'>
                                        ...
                                        <textarea name='observations' cols='40' rows='10' type='text'
                                            ...
                                            class='textarea form-control' id='id_observations' value=''>{{ old('observations') }}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
