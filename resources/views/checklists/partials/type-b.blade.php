    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach([
                ...
                'is there a large radio/television station within 4 Km (if yes, contact the Head Logging vase for insturctions)?',
                ...
                'Have all opern fires, if any, in the vicinity of the well site been removed?',
