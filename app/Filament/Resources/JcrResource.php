        ...
        return $form
            ->schema([
                ...
                Forms\Components\DatePicker::make('assembled_date')
                    ->required(),
                Forms\Components\TextInput::make('assembled_time')
                    ->required(),
                Forms\Components\DatePicker::make('depOffice_date')
                    ->required(),
                Forms\Components\TextInput::make('depOffice_time')
                    ->required(),
                Forms\Components\DatePicker::make('arrivalSite_date')
                    ->required(),
                Forms\Components\TextInput::make('arrivalSite_time')
                    ->required(),
                Forms\Components\DatePicker::make('indented_date')
                    ->required(),
                Forms\Components\TextInput::make('indented_time')
                    ->required(),
                Forms\Components\DatePicker::make('wellReadiness_date')
                    ->required(),
                Forms\Components\TextInput::make('wellReadiness_time')
                    ->required(),
                Forms\Components\DatePicker::make('wellTaken_date')
                    ->required(),
                Forms\Components\TextInput::make('wellTaken_time')
                    ->required(),
                Forms\Components\DatePicker::make('rigUP_date')
                    ->required(),
                Forms\Components\TextInput::make('rigUP_time')
                    ->required(),
                Forms\Components\DatePicker::make('wellHandOver_date')
                    ->required(),
                Forms\Components\TextInput::make('wellHandOver_time')
                    ->required(),
                Forms\Components\DatePicker::make('depSite_date')
                    ->required(),
                Forms\Components\TextInput::make('depSite_time')
                    ->required(),
                Forms\Components\DatePicker::make('arrivalOffice_date')
                    ->required(),
                Forms\Components\TextInput::make('arrivalOffice_time')
                    ->required(),
